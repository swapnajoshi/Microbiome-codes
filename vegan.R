...
genus1 = scale(genus1, center=F, scale=colSums(genus1)) ## sacle it so they are relative abundances and not counts
...
chao1=estimateR(d.phylum*100000000)[2,]
shannon=diversity(d.phylum,  "shannon")
